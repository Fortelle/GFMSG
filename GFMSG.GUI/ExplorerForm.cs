...
public partial class ExplorerForm : Form
{
    ...
    private void ShowWrapper(MsgWrapper msg)
    {
        if (msg.Load() == false)
        {
            MessageBox.Show("Invalid message data file:\n" + msg.Filepath, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            return;
        }
    ...
    {
        foreach(var wrapper in multimsg.Wrappers.Values)
        {
            if (wrapper.Load() == false)
            {
                MessageBox.Show("Invalid message data file:\n" + wrapper.Filepath, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        }
